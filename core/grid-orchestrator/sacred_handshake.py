...
# Ensure we can import from the core engine
try:
...
# ═══════════════════════════════════════════════════════════════════════════════
#                    SACRED HANDSHAKE CLASS - KERNEL STABILIZER
# ═══════════════════════════════════════════════════════════════════════════════
...
class SacredHandshake:
    ...
    async def check_covenant_node(self) -> bool:
        ...
        if not hasattr(self.mo, "interpret"):
             # Basic sanity check if engine is partially mocked
             return True
