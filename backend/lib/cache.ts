...
let redis: { on: (arg0: string, arg1: (err: any) => void) => void; get: (arg0: any) => any; set: (arg0: any, arg1: string, arg2: string, arg3: any) => any; del: (arg0: any) => any; status: string; } | null;
try {
  redis = new Redis(process.env.REDIS_URL || 'redis://localhost:6379');
  
  (redis as RedisClient).on('error', (err) => {
